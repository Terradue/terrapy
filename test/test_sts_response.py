...
class TestStsResponse(unittest.TestCase):
    """StsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StsResponse:
        """Test StsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StsResponse`
        """
        model = StsResponse()
        if include_optional:
            return StsResponse(
