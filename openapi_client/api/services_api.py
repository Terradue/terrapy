...
class ServicesApi:
    ...
    @validate_call
    def cast_time_series(
        self,
        data_casting_request: Annotated[Optional[DataCastingRequest], Field(description="The request to cast a time series")] = None,
        ...
        :param data_casting_request: The request to cast a time series
        :type data_casting_request: DataCastingRequest
        ...
        _param = self._cast_time_series_serialize(
            data_casting_request=data_casting_request,
    ...
    @validate_call
    def cast_time_series_with_http_info(
        self,
        data_casting_request: Annotated[Optional[DataCastingRequest], Field(description="The request to cast a time series")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cast_time_series_without_preload_content(
        self,
        data_casting_request: Annotated[Optional[DataCastingRequest], Field(description="The request to cast a time series")] = None,
        _request_timeout: Union[
            None,
    ...
    def _cast_time_series_serialize(
        self,
        data_casting_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if data_casting_request is not None:
            _body_params = data_casting_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/services/timeseries/cast',
    ...
    @validate_call
    def get_data_casting_status_async(
        self,
        cast_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_data_casting_status_async_serialize(
            cast_id=cast_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_data_casting_status_async_with_http_info(
        self,
        cast_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_data_casting_status_async_without_preload_content(
        self,
        cast_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_data_casting_status_async_serialize(
        self,
        cast_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/services/datacast/casts/{castId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_data_casting(
        self,
        data_casting_request: Annotated[Optional[DataCastingRequest], Field(description="The casting request")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param data_casting_request: The casting request
        :type data_casting_request: DataCastingRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._post_data_casting_serialize(
            data_casting_request=data_casting_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_data_casting_with_http_info(
        self,
        data_casting_request: Annotated[Optional[DataCastingRequest], Field(description="The casting request")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_data_casting_without_preload_content(
        self,
        data_casting_request: Annotated[Optional[DataCastingRequest], Field(description="The casting request")] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_data_casting_serialize(
        self,
        data_casting_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/services/datacast/cast',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
