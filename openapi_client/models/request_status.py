...
class RequestStatus(BaseModel):
    ...
    RequestStatus
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the request")
    status: Optional[RequestStatusCode] = None
    links: Optional[List[Link]] = Field(default=None, description="Links to the resources related to the request")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "status", "links"]
