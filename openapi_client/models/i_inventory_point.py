...
class IInventoryPoint(BaseModel):
    """
    IInventoryPoint
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["inventoryType", "inventoryPointUri", "initialized", "remoteId", "resourceServer", "owner", "type", "status", "resource_uris", "scopes", "properties", "platformId", "name", "self"]
