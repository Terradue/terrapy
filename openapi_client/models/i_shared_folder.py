...
class ISharedFolder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["storageType", "storagePointUri", "serviceUri", "initialized", "endPoint", "remoteId", "resourceServer", "owner", "type", "status", "resource_uris", "scopes", "properties", "platformId", "name", "self", "background_job_id"]
